    ...
    <div>
        <nav class="navbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="/" class="nav-link">
                        <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 640 512"
                                class="svg-inline--fa fa-home fa-w-16 fa-9x"
                        >
                            <g class="fa-group">
                                <path
                                        fill="currentColor"
                ...
                <li class="nav-item">
                    <a href="/commands" class="nav-link">
                        <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 576 512"
                                class="svg-inline--fa fa-terminal fa-w-18 fa-9x"
                        >
                            <g class="fa-group">
                                <path
                                        fill="currentColor"
                ...
                <li class="nav-item">
                    <a href="https://discord.com/invite/TWjxyhC" target="_blank" class="nav-link">
                        <svg
                                ...
                                focusable="false"
                                data-prefix="fad"
                                data-icon="fa-discord"
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                                class="svg-inline--fa fa-discord fa-w-16 fa-5x"
                        >
                            <g class="fa-group">
                                <path
                                        fill="currentColor"
                ...
                <li class="nav-item">
                    <a href="https://www.patreon.com/join/dankdumpster" class="nav-link">
                        <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fad"
