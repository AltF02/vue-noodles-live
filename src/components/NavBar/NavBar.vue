<template>
    <div>
            ...
            <ul class="navbar-nav">
                <li class="logo">
                    <a href="/" class="nav-link">
                        <span class="link-text logo-text">Noodles</span>
                        <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fad"
        ...
        <main>
            <h1>Tech asjdh</h1>
            <p>Fortnite is een online computerspel ontwikkeld door Epic Games dat is uitgebracht in 2017. Het is beschikbaar in drie verschillende gamemodes die dezelfde algemene gameplay en engine delen: Fortnite: Save the World, een coöperatieve shooter-survivalgame voor maximaal vier spelers om zombie-achtige wezens te bestrijden en objecten te verdedigen met versterkingen die ze kunnen bouwen; Fortnite Battle Royale, een gratis Battle Royale-game waarin maximaal 100 spelers vechten om de laatste persoon te zijn die overeind blijft; en Fortnite Creative, waar spelers volledige vrijheid krijgen om werelden en strijdarena's te creëren. Save the World en Battle Royale zijn in 2017 uitgebracht als early access-titels, terwijl Creative is uitgebracht op 6 december 2018. Save the World is beschikbaar voor Windows, macOS, PlayStation 4 en Xbox One, en Battle Royale en Creative zijn uitgebracht voor al die platformen, en voor Nintendo Switch, iOS en Android.
